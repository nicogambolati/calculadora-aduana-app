...
export const Calculator = () => {
  ...
  const formattedTotalPesos = totalPesos.toLocaleString("es-AR", {
    style: "currency",
    currency: "ARS",
  });

  return (
      <div className="col-12 col-md-6 card d-flex aligns-items-center justify-content-center card text-center">
